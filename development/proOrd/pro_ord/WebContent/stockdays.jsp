...
<title><bean:message key="title.stockdays" /></title>
...
<H3><bean:message key="title.stockdays2" /></H3>
...
<table border="0" cellspacing="0" cellpadding="2">
	...
	<td valign="top">
		<html:form action="/GomasterMenu" target="_top">
			...
			<html:hidden property="pagingHelperType" value="com.jds.prodord.master.stockdays.StockDaysPagingHelper"/>
		</html:form>
	</td>
	<td>
...
<html:form action = "/StockDays" target="_self" onsubmit="return acceptSubmit();">
<bean:define id="fmForm" name="StockDaysForm" type="com.jds.prodord.master.stockdays.StockDaysForm"/>
...
<table ><tr><td>
	...
	<table align="left" cellspacing="8">
		<tr >	
			<td style="width:100px;height:22px;" class="title_dark"><bean:message key="label.syorikbn"/></td>
			<td style="width:100px;height:22px;" class="title_dark"><bean:message key="label.kaiskb"/></td>
			<td style="width:80px;height:22px;" class="title_dark"><bean:message key="label.rank"/></td>
			<td style="width:120px;height:22px;" class="title_dark"><bean:message key="label.ketcod"/></td>
			<td style="width:150px;height:22px;" class="title_dark"><bean:message key="label.zaisuuittkatu"/></td>
		</tr>
		<tr>
			<td align="center">
			...
			<td align="center">
				<html:text property="stockDays" styleClass="s_10" maxlength="2" style="text-align: right"/>
			</td>
		</tr>
	</table>
    ...
    <tr><td>
	    ...
	    <table border="0" bgcolor="#336666" cellspacing="1" cellpadding="1">
	        <tr>
	            ...
	            <td class="title_light" style="width:100px"><bean:message key="label.kaiskb_"/></td>
	            <td class="title_light" style="width:100px"><bean:message key="label.rank"/></td>
	            <td class="title_light" style="width:100px"><bean:message key="label.ketcod"/></td>
	            <td class="title_light" style="width:100px"><bean:message key="label.zainssu"/></td>
	        </tr>

		<logic:iterate name="StockDaysForm" id="row" indexId="index"  property="formRowList" >
	        <tr>
	            ...
	            <td align="left" bgcolor="#FFFFFF">
					...
					<bean:write name ="StockDaysForm" property="<%= propertyName%>" />
	            </td>
	            <td align="left" bgcolor="#FFFFFF">
	            ...
	            <td align="center" bgcolor="#FFFFFF">
	            	<% propertyName = "outStockDays[" + index + "]";%>
