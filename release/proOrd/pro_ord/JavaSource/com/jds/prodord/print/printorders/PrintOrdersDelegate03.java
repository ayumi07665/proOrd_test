...
/**
 * PrintOrdersDelegate03 発注書印刷処理実行クラス（Ｋ社用）.<BR>
 * <dt><b>作成日: </b></dt>
 * <dd>2005/06/28</dd>
 * <dt><B>作成者: </b></dt>
 * <dd>(NII)蛭田</dd>
 ...
 * </table>
 */
public class PrintOrdersDelegate03 extends PrintOrdersDelegate{
	...
	public ArrayList getPageLayout(
		...
		ArrayList layout = fmDao.getPageLayout03(poQueryVO,date);
	...
	public String[] doCreateHacSyoBng(String kaiSkbCod, ArrayList numbers)throws SQLException{
		...
		try{
			...
			for(int i = 0; i < numbers.size(); i++){
				...
				int[] number = NumberingUtils.createNumbers(kaiSkbCod,bk.getHacCod(),bk.getPageCount(),bk.getSinKyuKbn());
